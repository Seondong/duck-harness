...
# Kept out of the block above because that one is unconditional. These three
# lines describe a mechanism that only exists when the framing pass is running;
# with framing off they told the model to spend its actions deciding "live
# hypotheses" that were permanently an empty list.
